...
Em um Blazor aplicativo Webassembly, personalize a experiência no `wwwroot/index.html` arquivo:
...
Em um Blazor aplicativo de servidor, personalize a experiência no `Pages/_Host.cshtml` arquivo:
