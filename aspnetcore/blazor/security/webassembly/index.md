...
O suporte de autenticação no Blazor Webassembly é criado sobre a biblioteca de *oidc-client.js* , que é usada para lidar com os detalhes do protocolo de autenticação subjacente.
