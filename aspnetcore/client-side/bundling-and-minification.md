...
### <a name="manually-convert-the-bundling-and-minification-workflow-to-use-gulp"></a>Converta manualmente o fluxo de trabalho de agrupamento e minificação para usar o Gulp
