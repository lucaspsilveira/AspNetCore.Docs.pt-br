...
* {USERNAME}: nome de usuário do MSDeploy. O {NOME DE USUÁRIO} pode ser encontrado no perfil de publicação.
...
------ | | `http://mysite.azurewebsites.net/`     | Aplicativo Web | | `http://mysite.scm.azurewebsites.net/` | Serviço kudu |
