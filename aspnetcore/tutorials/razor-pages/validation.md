...
Obrigado por concluir esta introdução às Razor páginas. Comece a usar as [ Razor páginas e EF Core](xref:data/ef-rp/intro) é um excelente acompanhamento deste tutorial.
