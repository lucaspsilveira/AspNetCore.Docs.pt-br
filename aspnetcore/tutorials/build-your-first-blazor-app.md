...
Se estiver trabalhando com um Blazor aplicativo Webassembly, <xref:System.Net.Http.HttpClient> será injetado para obter dados de previsão do tempo do *weather.jsno* arquivo na pasta *wwwroot/Sample-data* .
