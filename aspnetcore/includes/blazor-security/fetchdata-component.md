<span data-ttu-id="36aed-101">O `FetchData` componente mostra como:</span><span class="sxs-lookup"><span data-stu-id="36aed-101">The `FetchData` component shows how to:</span></span>
