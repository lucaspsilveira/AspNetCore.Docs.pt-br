...
>
> Para associar uma propriedade em `GET` solicitações, defina a [`[BindProperty]`](xref:Microsoft.AspNetCore.Mvc.BindPropertyAttribute) Propriedade do `SupportsGet` atributo como `true`:
>
> ```csharp
