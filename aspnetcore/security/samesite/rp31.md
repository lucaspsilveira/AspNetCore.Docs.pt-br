...
No código mostrado acima de autenticação de cookie e estado de sessão, defina seu atributo sameSite como None, emitindo o atributo com um `None` valor e também defina o atributo Secure como true.
...
Em seguida, em `ConfigureServices(IServiceCollection services)` Configurar a política de cookie para chamar uma classe auxiliar quando os cookies são anexados ou excluídos, assim;
