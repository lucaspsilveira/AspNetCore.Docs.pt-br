...
---
# <a name="aspnet-core-21-razor-pages-samesite-cookie-sample"></a>Exemplo de Razor SameSite 2,1 páginas de cookies de ASP.NET Core
...
No código anterior, a autenticação de cookie e o estado de sessão definem seu `None`atributo sameSite como, emitindo o `None` atributo com um valor e também definimos o `true`atributo Secure como.
