...
ms.locfileid: "82138411"
---
# <a name="secure-aspnet-core-opno-locblazor-webassembly"></a>Webassembly Blazor ASP.NET Core seguro
...
* Os pontos de extremidade do servidor não exigem proteção contra [falsificação de solicitação entre sites (CSRF)](xref:security/anti-request-forgery) porque os tokens são enviados explicitamente. Isso permite hospedar Blazor aplicativos Webassembly juntamente com aplicativos de páginas MVC ou Razor.
